...
public class DataAnalysis {
    public static void main(String[] args) throws IOException, WriteException {
       ...
       for(int datacnt=0;datacnt<27;datacnt++)
       {
           ...
           // 1、构造excel文件输入流对象
           String sFilePath = "C:\\data\\ali\\SVM\\"+array[datacnt]+"Task.xls";
           InputStream is = null;
           try {
...
//        System.out.println("工作表名称：" + oFirstSheet.getName());
           ...
           int num;
           int start = 269;//需要修改，为所在的行数，以及task数目
           int end = 1299;
           num =950;
           ...
           for(i=start-1;i<=end-1;i++)
           {
               ...
               int tmp1,tmp2;
               int stageid;
               stageid = Integer.valueOf(oFirstSheet.getCell(2,i).getContents().trim());

               if(stageid == 3||stageid == 5||stageid == 7||stageid == 9||stageid ==11||stageid == 13||stageid == 15||stageid == 17||stageid == 19||stageid == 21)
               {
