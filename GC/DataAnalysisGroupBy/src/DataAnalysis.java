...
public class DataAnalysis {
    public static void main(String[] args) throws IOException, WriteException {
       ...
       for(int datacnt=0;datacnt<27;datacnt++)
       {
           ...
           // 1、构造excel文件输入流对象
           String sFilePath = "C:\\data\\ali\\GroupByTest\\"+array[datacnt]+"Task.xls";
           InputStream is = null;
           try {
...
//        System.out.println("工作表名称：" + oFirstSheet.getName());
           ...
           int num;
           int start = 2;//需要修改，为所在的行数，以及task数目
           int end = 33;
           num =32;
        ...
        String path="E:\\DataAnalysisGroupBy\\newmapdata.xls" ;
        ...
        WritableSheet sheet = book.createSheet("ReduceDuration",0);
        ...
        WritableSheet sheet1 = book.createSheet("ReduceGC",1);
